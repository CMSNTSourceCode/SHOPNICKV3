...
function ltrFn() {
    ...
    if (!document.querySelector('#style').href.includes('bootstrap.min.css')) {
        document
            .querySelector('#style') ?.setAttribute('href', '/_admin/libs/bootstrap/css/bootstrap.min.css')
    }
...
function rtlFn() {
    ...
    document
        .querySelector('#style') ?.setAttribute('href', '/_admin/libs/bootstrap/css/bootstrap.rtl.min.css')
    checkOptions()
}
