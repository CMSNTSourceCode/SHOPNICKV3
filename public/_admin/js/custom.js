...
const values = [{
        value: '1',
        label: '<img class="avatar avatar-xs avatar-rounded" src="/_admin/images/flags/us_flag.jpg" alt=""> <span class="mx-1">United States</span>',
        id: 1,
    },
    {
        value: '2',
        label: '<img class="avatar avatar-xs avatar-rounded" src="/_admin/images/flags/spain_flag.jpg"  alt=""> <span class="ms-1">Spain</span>',
        id: 2,
    },
    {
        value: '3',
        label: '<img class="avatar avatar-xs avatar-rounded" src="/_admin/images/flags/french_flag.jpg" alt=""> <span class="ms-1">France</span>',
        id: 3,
    },
    {
        value: '4',
        label: '<img class="avatar avatar-xs avatar-rounded" src="/_admin/images/flags/germany_flag.jpg" alt=""> <span class="ms-1">Germany</span>',
        id: 4,
    },
    {
        value: '5',
        label: '<img class="avatar avatar-xs avatar-rounded" src="/_admin/images/flags/italy_flag.jpg" alt=""> <span class="ms-1">Italy</span>',
        id: 5,
    },
    {
        value: '6',
        label: '<img class="avatar avatar-xs avatar-rounded" src="/_admin/images/flags/russia_flag.jpg" alt=""> <span class="ms-1">Netherlands</span>',
        id: 6,
    },
    {
        value: '7',
        label: '<img class="avatar avatar-xs avatar-rounded" src="/_admin/images/flags/argentina_flag.jpg" alt=""> <span class="ms-1">Argentina</span>',
        id: 7,
    },
    {
        value: '8',
